...
pnpm test                                   # tests only (177 across the workspace)
pnpm format:check
...
- **Implementation and tests.** Claude wrote the code and the 177 tests in small commits, running lint, typecheck and tests after each step. Current package versions and Expo/Binance behaviour were checked against npm and the official docs rather than assumed.
